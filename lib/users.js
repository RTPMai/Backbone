...
//
// ESM, matching the rest of the project. Mixing CommonJS (`require`) with ESM (`export`)
// is what produced "setSessionCookie is not a function" — the require() returned a module
// object whose named properties didn't destructure.
//
// Sits alongside lib/session.js (cookies + signing) and adds:
